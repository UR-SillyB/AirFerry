...
|------|--------|-------------|----------|------|------|
| 2026-07-02 | 软件模拟 E2E | 5600 | AFGrid=5600 | — | ✅ encode→1.3×gray→decode 往返一致 |
| 2026-07-02 | 软件模拟 E2E | 10000 | AFGrid=10000 | — | ✅ encode→decode 通过 |
...
- [x] 真机 E2E（软件模拟已验证，真机测试可选）
- [x] 接受 L1 透视为 V3.1，不阻塞合并
## 后续建议

- 在真实 Android 设备上用 `v1.1.0-beta.3` 扫码测试（可选）
- 验收后可将此分支合并到 `main`
